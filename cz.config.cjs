module.exports = {
  types: [
    ...
    { value: 'build', name: '构建：变更项目构建或外部依赖（例如修改vite、webpack等）' },
    { value: 'ci', name: '自动化构建：更改持续集成软件的配置文件和 package 中的 scripts 命令，例如 scopes: Travis, Circle 等' },
    { value: 'chore', name: '其他修改：变更构建流程或辅助工具' },
    { value: 'revert', name: '回滚：代码回退到某个版本节点' },
    { value: 'wip', name: '任务：进行中的工作' },
  ...
  allowBreakingChanges: ['feat', 'fix', 'perf', 'style', 'docs', 'refactor', 'build', 'ci', 'chore', 'revert', 'update'],
  subjectLimit: 100
}